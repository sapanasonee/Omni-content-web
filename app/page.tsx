    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="mt-5 text-lg text-gray-500 max-w-xl mx-auto">
          Vowwl learns your voice from how you write — and how you edit — then drafts
          LinkedIn posts, tweets and newsletters your audience will actually believe you wrote.
        </p>
